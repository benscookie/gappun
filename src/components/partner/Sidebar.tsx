    ...
    <aside className="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col">
      ...
      <nav className="flex-1 p-4">
        <div className="mb-2 px-3">
          <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">논알콜 맥주</span>
        </div>
        <div className="flex items-center gap-2 px-3 py-2 mb-4">
          <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center text-white text-sm">
            B2B
          </div>
          <span className="font-medium text-gray-800">B2B 파트너</span>
        </div>
